      ...
      <header className="sticky top-0 z-40 w-full border-b bg-white">
        <div className="container flex h-16 items-center justify-between py-4">
          <div className="flex items-center gap-2">
            <Image src="/images/easter-logo.svg" alt="PascoaYou Logo" width={40} height={40} />
            <span className="text-xl font-bold text-pink-500">PascoaYou</span>
          </div>
      ...
      <footer id="contact" className="bg-pink-900 text-white py-12">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <Image src="/images/easter-logo-white.svg" alt="PascoaYou Logo" width={40} height={40} />
                <span className="text-xl font-bold">PascoaYou</span>
              </div>
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center text-white/50 text-sm">
            &copy; {new Date().getFullYear()} PascoaYou. Todos os direitos reservados.
          </div>
        </div>
      </footer>
    </div>
